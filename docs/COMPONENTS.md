...
- **Image:** `ghcr.io/ega-archive/beacon2-pi-api:v2.1.2` (pinned in `deploy/docker-compose/docker-compose.beacon.yml`; GHCR — [package](https://github.com/EGA-archive/beacon2-pi-api/pkgs/container/beacon2-pi-api))
...
- **HelixTest (CI / local):** see [HELIXTEST.md](HELIXTEST.md) for Phase 1 (`BEACON_URL`, `/ga4gh/beacon/v2`, `--mode ferrum`) and Phase 2 WES (`WES_URL`, Sapporo on `:1122`).
